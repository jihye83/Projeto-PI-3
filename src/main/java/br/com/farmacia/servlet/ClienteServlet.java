...
public class ClienteServlet extends HttpServlet {
    ...
    private static String INSERT_OR_EDIT = "/protegido/admin/gerenteglobal/gerentefilial/vendedor/cadastrarCliente.jsp";
    private static String LIST_CLIENTE = "/protegido/admin/gerenteglobal/gerentefilial/listaCliente.jsp";
