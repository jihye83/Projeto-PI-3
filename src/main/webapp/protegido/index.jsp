...
<!DOCTYPE html>
    ...
    <head>
        ...
        <a href="<c:url value="/ProdutoServlet?action=listaProduto"/>">Listar Produtos</a><br/>
        ...
        <a href="<c:url value="/FornecedorServlet?action=listaFornecedor"/>">Listar Fornecedor</a><br>
        <a href="cadastrarFuncionario.jsp">Cadastrar Funcionario</a><br>
        <a href="<c:url value="/FuncionarioServlet?action=listaFuncionario"/>">Listar Funcionario</a><br>
        <a href="cadastrarFilial.jsp">Cadastrar Filial</a><br/>
        <a href="<c:url value="/FilialServlet?action=listaFilial"/>">Listar Filiais</a><br/>
        <a href="<c:url value="/VendaServlet?action=listaClienteProduto"/>">vendas</a>
        <br/>
        <br/>
