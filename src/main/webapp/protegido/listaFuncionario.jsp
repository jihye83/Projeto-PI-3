...
<html>
    ...
    <body class="container">
        <div class="listaFuncionarioArea">
            <div class="listaFuncionarioArea">
                <a href="<c:url value="/FuncionarioServlet?action=insert"/>" class="btn-add-funcionario"> Cadastrar Funcionario</a>
                    ...
                    <tbody>
                        <c:forEach items="${funcionarios}" var="funcionario">
                            <tr>
                                ...
                                <td><a class="btn btn-primary " href="FuncionarioServlet?action=edit&funcionarioCpf=<c:out value="${funcionario.cpf}" />">
                                ...
                                <td><button type="button" class="btn btn-primary btn-excluir" onclick="mostrarModalExclusao('${funcionario.nome}', '${funcionario.cpf}')">
